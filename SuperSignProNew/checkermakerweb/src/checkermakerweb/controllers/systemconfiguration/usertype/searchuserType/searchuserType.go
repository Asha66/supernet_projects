...
type SearchuserType struct {
	beego.Controller
}

func (c *SearchuserType) Get() {
	...
	defer func() {
		...
		if err != nil {
			...
			c.TplName = "systemconfiguration/usertype/searchuserType/searchuserType.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "Search Usertype Page Fail")
		} else {
			c.Data["DisplayMessage"] = ""
			c.TplName = "systemconfiguration/usertype/searchuserType/searchuserType.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "Search Usertype  Page Success")
		}
		return
	}()
	...
	// }
	// log.Println(beego.AppConfig.String("loglevel"), "Debug", "IsAuthorized - ", "Authorized")
	data, err := services.SearchUsertype()
	if err != nil {
		log.Println(beego.AppConfig.String("loglevel"), "Error", err)
		//err = errors.New("UserType fetch Failed")
		if language == "english" {
			err = errors.New(beego.AppConfig.String("EN_USERTYPE_FETCH_FAILED"))
			log.Println(beego.AppConfig.String("loglevel"), "ENGLISH Error", err)
			return
		} else if language == "french" {
			err = errors.New(beego.AppConfig.String("FN_USERTYPE_FETCH_FAILED"))
...
func (c *SearchuserType) Post() {
	...
	log.Println(beego.AppConfig.String("loglevel"), "Debug", "channelstatus", input_name)
	...
	data, err := services.SearchUsertypeByFilter(input_name+"%", from, to, input_status)
	if err != nil {
		log.Println(beego.AppConfig.String("loglevel"), "Error", err)
		//err = errors.New("usertype fetch Failed")
		if language == "english" {
