...
func (c *ViewStatus) Get() {
	...
	defer func() {
		...
		if err != nil {
			...
			c.TplName = "systemconfiguration/status/viewStatus/viewStatus.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Status Page Fail")
		} else {
			c.Data["DisplayMessage"] = ""
			c.TplName = "systemconfiguration/status/viewStatus/viewStatus.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Status  Page Success")
		}
		return
	}()
